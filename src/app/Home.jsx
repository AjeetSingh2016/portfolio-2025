...
export default function Home() {
  ...
  const [bio] = useState(
    "Frontend & Mobile Dev specializing in React Native & Next.js",
  );
  const [avatarUrl] = useState(
    "https://pbs.twimg.com/profile_images/1920177749748051968/bxZ_2Rhe_400x400.jpg",
  );
  ...
  const featuredProjects = [
    ...
    },
    {
      ...
      description:
        "Handcrafted 3D assets for designers & developers. Download PNG or JPG instantly.",
      icon: (
        <img
  ...
  const links = [
    {
      title: "Twitter",
      url: "https://x.com/AjeetSingh76422",
      icon: <FaTwitter />,
      description: "Thoughts on development and tech",
    },
    {
      title: "Portfolio",
    ...
    {
      title: "GitHub",
      url: "https://github.com/AjeetSingh2016",
      icon: <FaGithub />,
      description: "Open source contributions",
    },
    {
      title: "LinkedIn",
      url: "https://www.linkedin.com/in/ajeet-singh-063978177/",
      icon: <FaLinkedin />,
            ...
            {links.slice(0, 4).map((link, index) => (
              ...
              >
                ...
                <div className="relative">
                  ...
                  <p className="text-[10px] md:text-xs lg:text-sm text-gray-400 line-clamp-2">
                    {link.description}
                  </p>
                </div>
              </motion.a>
